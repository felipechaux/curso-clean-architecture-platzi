package com.platzi.android.rickandmorty.api // ktlint-disable filename
...
class EpisodeRetrofitDataSource(
    ...
    override fun getEpisodesFromCharacter(episodeUrlList: List<String>): Single<List<Episode>> {
